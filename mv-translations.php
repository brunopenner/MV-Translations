	...
	class MV_Translations{
        ...
        public static function activate(){
            ...
            if (empty ($mvt_db_version)) {
                $query = "
                    CREATE TABLE $table_name (
                        ...
                        translation_id bigint(2) NOT NULL DEFAULT '0',
            ...
            if ($wpdb->get_row("SELECT post_name FROM {wpdb->prefix}posts WHERE post_name = 'submit-translation'") === null) {
                ...
                $page = array(
                    'post_title'    => __('Submit Translation', 'mv-translation'),
            ...
            if ($wpdb->get_row("SELECT post_name FROM {wpdb->prefix}posts WHERE post_name = 'edit-translation'") === null) {
                $current_user = wp_get_current_user();
                $page = array(
                    'post_title'    => __('Edit Translation', 'mv-translation'),
        ...
        public static function uninstall(){
            dele_option('mv_translation_db_version');
        ...
        public function register_scripts() {
            ...
            wp_register_script('validate_js', MV_TRANSLATIONS_URL . 'assets/jquery.validate.min.js', array('jquery'), MV_TRANSLATIONS_VERSION, true); wp_register_script('validate_js', MV_TRANSLATIONS_URL . 'assets/jquery.validate.min.js', array('jquery'), MV_TRANSLATIONS_VERSION, true);
