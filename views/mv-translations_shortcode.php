    ...
    <form action="" method="POST" id="translations-form">
        ...
        <fieldset id="additional-fields">
            ...
            <select name="mv_translations_transliteration" id="mv_translations_transliteration">
                <option value="Yes" <?php if(isset($transliretarion)) selected($transliretarion, "Yes"); ?>><?php esc_html_e( 'Yes', 'mv-translations' ); ?></option>
                <option value="No" <?php if(isset($transliretarion)) selected($transliretarion, "No"); ?>><?php esc_html_e( 'No', 'mv-translations' ); ?></option>
            </select>
